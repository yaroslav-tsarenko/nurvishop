...
export const metadata = { title: "Terms and Conditions — nurvishop" };
  ...
  return (
    <PolicyLayout title="Terms and Conditions" lastUpdated="29 May 2026">
      <p>
        ...
        www.nurvishop.com and any related pages, services, orders, purchases, communications, and
        transactions operated under the nurvishop brand.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In these Terms, &ldquo;nurvishop&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo; means AVONTRA LTD.
      ...
      <p>
        ...
        account, submitting an order, or purchasing goods from nurvishop, you agree to be bound by these
        Terms.
      </p>

      <h2>1. Scope of These Terms</h2>
      <p>1.1 These Terms apply to all use of the Website and all purchases of goods made through nurvishop.</p>
      <p>
        1.2 nurvishop sells physical electrical products, electrical materials, wiring accessories,
      ...
      <p>
        2.4 You must not use the Website or purchase goods from nurvishop for any unlawful, unsafe,
        fraudulent, or unauthorised purpose.
      </p>

      <h2>3. Consumer and Business Customers</h2>
      <p>3.1 nurvishop sells to both consumers and business customers.</p>
      <p>
      ...
      <p>
        5.4 nurvishop does not provide electrical engineering, installation, compliance, inspection,
      ...
      <p>
        ...
        nurvishop is general information only and must not be treated as a substitute for professional
      ...
      <p>
        7.3 A contract between you and nurvishop is formed only when we accept your order, process it for
      ...
      <p>
        ...
        differences are the responsibility of the customer and are not controlled by nurvishop.
      </p>
      ...
      <p>
        9.3 Payments are processed by secure third-party payment providers. nurvishop does not store your
      ...
      <p>
        10.1 From time to time, nurvishop may offer discounts, promotional codes, special prices, free
      ...
      <p>11.1 nurvishop dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        12.3 nurvishop has no control over customs processing times, customs decisions, import restrictions,
      ...
      <p>
        ...
        failure to comply with local requirements, nurvishop will not be responsible for the resulting loss,
      ...
      <p>
        14.4 To exercise your cancellation right, you must inform us clearly by email at info@nurvishop.com
      ...
      <p>
        ...
        possible at info@nurvishop.com.
      </p>
      <p>
      ...
      <p>
        ...
        commercial warranty, additional warranty, or return policy offered by nurvishop.
      </p>
      <p>
      ...
      <p>18.1 nurvishop may offer paid additional warranty options for selected products.</p>
      ...
      <p>
        18.9 To make an Additional Warranty claim, you must contact us at info@nurvishop.com with your order
      ...
      <p>
        20.1 Products sold by nurvishop may be designed for specific markets, standards, voltage systems,
      ...
      <p>
        20.3 We do not guarantee that products purchased from nurvishop will meet every local building code,
      ...
      <p>
        ...
        descriptions, photographs, videos, design elements, and other materials, belongs to nurvishop,
      ...
      <p>25.3 Subject to sections 25.1 and 25.2, nurvishop will not be liable for:</p>
      <ul>
