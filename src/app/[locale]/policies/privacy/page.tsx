...
export const metadata = { title: "Privacy Policy — nurvishop" };

export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="29 May 2026">
      <p>
        This Privacy Policy explains how AVONTRA LTD, trading as nurvishop, collects, uses, stores, shares,
        and protects personal data when you visit www.nurvishop.com, create an account, place an order,
        contact us, use our services, or otherwise interact with us.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Privacy Policy, &ldquo;nurvishop&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
      ...
      <p>3.1 The personal data we collect depends on how you interact with nurvishop.</p>
      ...
      <p>
        ...
        the relevant email or contacting us at info@nurvishop.com.
      </p>
      <p>
      ...
      <p>
        11.1 Because nurvishop sells internationally and uses third-party service providers, your personal
      ...
      <p>14.3 To exercise your rights, please contact us at info@nurvishop.com.</p>
      ...
      <p>
        ...
        info@nurvishop.com so we can try to resolve the matter.
      </p>
      <p>
      ...
      <p>
        ...
        info@nurvishop.com and we will take appropriate steps to review and delete the information where
        required.
      </p>
