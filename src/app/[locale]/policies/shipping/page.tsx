...
export const metadata = { title: "Shipping Policy — nurvishop" };

export default function ShippingPolicyPage() {
  return (
    <PolicyLayout title="Shipping Policy" lastUpdated="29 May 2026">
      <p>
        This Shipping Policy explains how orders placed through www.nurvishop.com are processed,
      ...
      <p>1.1 This Policy applies to the delivery of physical goods purchased through nurvishop.</p>
      <p>
        1.2 nurvishop supplies electrical products, electrical materials, wiring accessories,
      ...
      <p>3.1 nurvishop dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        5.4 nurvishop is not responsible for delays caused by customs authorities, local postal operators,
      ...
      <p>
        7.3 nurvishop is not responsible for delays, failed deliveries, lost parcels, return charges, or
      ...
      <p>
        8.1 nurvishop may accept international orders to supported delivery destinations shown on the
      ...
      <p>
        9.3 nurvishop does not control customs authorities, import tax assessments, duty rates, customs
      ...
      <p>
        12.4 nurvishop is not responsible for failed delivery where you do not respond to courier notices, do
      ...
      <p>
        ...
        extended period, please contact us at info@nurvishop.com.
      </p>
      <p>
      ...
      <p>
        16.2 nurvishop is not responsible for loss, damage, delay, customs issues, onward shipping problems,
      ...
      <p>
        17.3 nurvishop is not responsible for labour costs, electrician costs, contractor costs, installation
